        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 mx-auto">
                    <div class="card">
                        <div class="card-header font-weight-bolder bg-dark text-white">My Calculator</div>
                        <div class="card-body">
                            <form action="action.php" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="submit" name="btn" class="btn btn-outline-success mx-auto" value="submit"/>
                                    </div>
                                </div>
                            </form>
                        </div>
